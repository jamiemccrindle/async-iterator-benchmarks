...
exports.range = range;
function reduce(reducer, initial, source) {
    return __awaiter(this, void 0, void 0, function () {
        var accumulator, source_1, source_1_1, item, e_1_1, e_1, _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 13: return [2 /*return*/, accumulator];
            }
        });
    });
}
...
function run(numberOfItems) {
    return reduce(function (accumulator, next) { return accumulator + next; }, 0, range(0, numberOfItems));
}
exports.run = run;